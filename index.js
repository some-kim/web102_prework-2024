...
function addGamesToPage(games) {
    ...
    for (let i = 0; i < games.length; i++) {
        ...
        gameCardDiv.innerHTML =  `<h3>${game.name}</h3>
...
contributionsCard.innerHTML = `<strong>Total Contributions:</strong> ${totalContributions.toLocaleString()}`;
raisedCard.innerHTML = `<strong>Total Raised:</strong> $${totalRaised.toLocaleString()}`;
...
gamesCard.innerHTML = `<strong>Total Number of Games:</strong> ${GAMES_JSON.length}`;
...
const unfundedGamesExplanation = numberOfUnfundedGames === 0
...
messageElement.textContent = unfundedGamesExplanation;
